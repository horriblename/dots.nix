...
vim.keymap.set('n', '<leader>c ', '"zciw<C-r>=v:lua.space_case(@z)<CR><Esc>', withDesc('to space-separated'))
...
vim.keymap.set('x', '<leader>c ', '"zc<C-r>=v:lua.space_case(@z)<CR><Esc>', withDesc('to space-separated'))
